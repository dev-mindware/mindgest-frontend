...
export function SentEmail (){
    ...
    return (
      ...
      <div className="w-full max-w-xs">
        ...
        <p className="text-sm text-center text-foreground/70">Digite seu endereço de e-mail e enviaremos instruções para redefinir sua senha.</p>
        </div>
        <div className="mt-4">
        <Label className="text-foreground/70">Email</Label>
        <InputEmail placeholder="Endereço de email"/>
        <Button onClick={() => openModal('otp')} className="w-full mt-4">Continuar</Button>
