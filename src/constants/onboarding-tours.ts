  ...
  dashboard: defineTour("dashboard", {
    ...
    steps: [
      tourStep(
        "dashboard-header",
        "Visão operacional",
        "Acompanhe o resumo executivo inteligente do seu negócio, seja na perspetiva global da empresa ou focada numa loja específica.",
        { side: "bottom" },
      ),
      tourStep(
        "dashboard-period",
        "Período de análise",
        "Alterne facilmente a janela temporal entre mensal, trimestral ou anual para recalcular todos os indicadores e métricas em tempo real.",
        { side: "left" },
      ),
      tourStep(
        "dashboard-summary",
        "Indicadores-chave",
        "Monitore o faturamento, volume de vendas, clientes ativos e itens em catálogo. As percentagens mostram o crescimento face ao período anterior.",
        { side: "bottom" },
      ),
      tourStep(
        "dashboard-revenue",
        "Evolução financeira",
        "Analise a relação temporal entre receitas, despesas e lucro líquido para acompanhar a saúde e rentabilidade do seu negócio.",
        { side: "top" },
      ),
      tourStep(
        "dashboard-distribution",
        "Distribuição das vendas",
        "Compare a proporção de receitas geradas por produtos versus serviços para entender a composição e os pontos fortes do faturamento.",
        { side: "left" },
      ),
      tourStep(
        "dashboard-clients",
        "Gestão de clientes",
        "Acompanhe o total de clientes cadastrados, novas adesões, taxa de retenção/recorrência e o controlo de clientes com saldos pendentes.",
        { side: "top" },
      ),
      tourStep(
        "dashboard-receivables",
        "Contas a receber",
        "Controle o valor total a receber distribuído por faixas de vencimento — valores vencidos, a vencer em 7 dias e a 30 dias — para proteger a liquidez.",
        { side: "top" },
      ),
      tourStep(
        "dashboard-stock",
        "Estado do inventário",
        "Consulte o valor monetário imobilizado em stock e identifique com rapidez os itens com stock baixo ou já esgotados que exigem reposição.",
        { side: "top" },
      ),
      tourStep(
        "dashboard-recent-activity",
        "Atividade recente",
        "Consulte os movimentos operacionais mais recentes da empresa — faturas emitidas, pagamentos recebidos, novos clientes e ajustes de stock.",
        { side: "top" },
      ),
      tourStep(
        "dashboard-monthly-goal",
        "Meta do período",
        "Acompanhe o atingimento da meta financeira estabelecida, visualizando a percentagem cumprida e o montante em falta.",
        { side: "left" },
      ),
      tourStep(
        "dashboard-stores-breakdown",
        "Desempenho por loja",
        "Compare o faturamento, produtos vendidos e serviços prestados por cada unidade física da sua empresa.",
        { side: "top" },
      ),
    ],
  }),
