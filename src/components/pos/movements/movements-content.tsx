...
import { Tabs, TabsContent, TabsList, TabsTrigger, TitleList, InvoiceReceiptList, CreditNotesList } from "@/components";
import { ProformaList } from "@/components/clients/documents/invoice-proforma/proforma-list";
