"use client";
import {
  Icon, Input, Button, Popover, Checkbox, SeeProduct,
  EditProduct, DeleteProduct, PopoverContent, PopoverTrigger,
} from "@/components";
...
export function ProductList({
  ...
  const {
    ...
    paginatedProducts, uniqueCategories, totalResults, totalPages,
