...
import { useModal, currentSupplierStore } from "@/stores";
import { SupplierFormData, supplierSchema } from "@/schemas";
import { useAddSupplier, useUpdateSupplier } from "@/hooks/entities";
...
export function SupplierModal({ action }: SupplierModalProps) {
    ...
    const { mutateAsync: editSupplier, isPending: isEditing } = useUpdateSupplier();
