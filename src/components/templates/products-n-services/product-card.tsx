...
import { Button, Badge, Icon, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, Card, CardContent, CardHeader } from '@/components';
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <Badge variant="secondary" className={product.isActive ? "text-xs text-green-700 bg-green-100 border-green-200" : "text-xs text-red-700 bg-red-100 border-red-200"}>
