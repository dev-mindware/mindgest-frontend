...
export function StockFilters() {
    ...
    function clearFilters() {
        setFilters({
            ...
            includeItem: undefined,
            includeStore: undefined,
        ...
        <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-2">
                ...
                <FilterPopover
                    ...
                    value={filters.lowStock === true ? "true" : filters.lowStock === false ? "false" : ""}
                    onChange={(value) => {
                        const lowStock = value === "true" ? true : value === "false" ? false : undefined;
                        setFilters({ lowStock });
                    }}
                />
                ...
                <FilterPopover
                    ...
                    options={booleanOptions}
                    value={filters.outOfStock === true ? "true" : filters.outOfStock === false ? "false" : ""}
                    onChange={(value) => {
                        const outOfStock = value === "true" ? true : value === "false" ? false : undefined;
                ...
                <FilterPopover
                    ...
                    label="Tem Reservado"
                    options={booleanOptions}
                    value={filters.hasReserved === true ? "true" : filters.hasReserved === false ? "false" : ""}
                    onChange={(value) => {
                        const hasReserved = value === "true" ? true : value === "false" ? false : undefined;
                ...
                <Button
                    ...
                    className="h-10"
                >
                    <Icon name={showAdvanced ? "ChevronUp" : "ChevronDown"} className="w-4 h-4 mr-2" />
                    Filtros Avançados
                </Button>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-4 bg-muted/50 rounded-lg">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFilters({ minQuantity: e.target.value ? Number(e.target.value) : undefined })}
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFilters({ maxQuantity: e.target.value ? Number(e.target.value) : undefined })}
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFilters({ minAvailable: e.target.value ? Number(e.target.value) : undefined })}
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFilters({ maxAvailable: e.target.value ? Number(e.target.value) : undefined })}
                        />
                    </div>
