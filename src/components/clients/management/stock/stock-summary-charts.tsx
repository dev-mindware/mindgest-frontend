...
export function StockSummaryCharts() {
    ...
    if (isError) {
        return <RequestError refetch={refetch} message="Erro ao carregar o resumo do estoque" />;
    }
    ...
    const chartData = [
        { outPercentage: summary.outOfStockPercentage, lowPercentage: summary.lowStockPercentage, adequate: summary.adequateStockCount },
    ];
    ...
    const stats: { title: string; value: number; icon: keyof typeof icons; description: string }[] = [
        {
                ...
                <Card className="border-muted-foreground/10 shadow-none overflow-hidden">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-7">
                        <div className="space-y-1">
                            <CardTitle className="text-xl font-semibold">Estatística Mensal de Estoque</CardTitle>
                            <CardDescription>Distribuição mensal dos níveis de inventário por categoria</CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent className="pl-2">
                        <ChartContainer config={chartConfig} className="h-[300px] w-full">
                            ...
                            >
                                <defs>
                                    <linearGradient id="colorAdequate" x1="0" y1="0" x2="0" y2="1">
