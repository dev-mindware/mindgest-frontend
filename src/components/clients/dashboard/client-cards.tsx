      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="flex gap-2 font-medium line-clamp-1">
            Tendência alta neste mês <Icon name="TrendingUp" className="size-4" />
          </div>
          <div className="text-muted-foreground">
            Vendas realizadas nos últimos meses
          </div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="flex gap-2 font-medium line-clamp-1">
            Queda de 20% neste período <Icon name="TrendingDown" className="size-4" />
          </div>
          <div className="text-muted-foreground">
