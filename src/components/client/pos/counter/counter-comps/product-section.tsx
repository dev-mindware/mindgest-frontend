        ...
        <div className="flex gap-3.5">
          ...
          <Tooltip>
              ...
              <div className="flex flex-col justify-between py-1 flex-1 overflow-hidden cursor-help">
                ...
                <div className="pt-1">
                  {product.reserved > 0 ? (
                    <Badge
                      variant="success"
                      className="text-[10px] sm:text-[9px] px-2 sm:px-1.5 py-0.5 sm:py-0"
                    >
            ...
            <TooltipContent
              side="right"
              align="start"
              className="max-w-[220px] p-3 flex flex-col gap-1.5 shadow-xl border-border/50"
            >
              <h4 className="font-bold text-sm leading-tight text-primary-foreground">
                {product.name}
              </h4>
