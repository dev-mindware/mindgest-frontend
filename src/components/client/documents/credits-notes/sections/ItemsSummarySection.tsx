        ...
        <div className="space-y-8">
                ...
                <div className="overflow-x-auto rounded-lg border border-border shadow-sm">
                    <table className="w-full">
                        <thead className="bg-card border-border">
                            <tr className="text-foreground">
                                ...
                                <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider">Qtd.</th>
                                <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider">Preço Unit.</th>
                            ...
                            {fields.map((field, index) => (
                                <tr key={field.id}>
                                    ...
                                    <td className="px-4 py-3 text-right w-24">
                                        <Input
                                            type="number"
                                            {...register(`invoiceBody.items.${index}.quantity`, { valueAsNumber: true })}
                    ...
                    {fields.length === 0 && (
                        <div className="p-8 text-center text-muted-foreground bg-muted/10 border-t border-dashed">
                            Nenhum item restante. Por favor, adicione itens ou anule o documento.
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="p-4 rounded-lg bg-primary/5 space-y-2">
                    <h4 className="font-semibold text-sm uppercase">Resumo da Nota de Crédito (Delta)</h4>
                ...
                <div className="p-4 rounded-lg bg-orange-500/5 space-y-2">
                    <h4 className="font-semibold text-sm uppercase">Novo Estado do Documento</h4>
                    <div className="flex justify-between">
                        <span>Subtotal:</span>
